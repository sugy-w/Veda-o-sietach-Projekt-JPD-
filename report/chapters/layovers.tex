...
V prestupovej analýze uvažujeme ohodnotenie každej hrany siete rovné $1$ (reprezentácia jedného letu). Výsledná vzdialenostná matica $\mathbf{D} \in \mathbb{R}^{3214 \times 3214}$ 
...
je na úrovni $2.297$ – pre akúkoľvek dvojicu letísk je v priemere potrebných aspoň takýto počet prestupov.
...
by malo dĺžku zhruba nad $6000$ km, v zmysle skúmanej logistickej siete je na úrovni až $35714.2$ km. Pre lepšie uchopenie, jedná sa o približne polovicu rovníkového obvod Zeme a v prípade (prísne hypotetickom)
