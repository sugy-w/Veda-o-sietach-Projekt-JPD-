...
\section{Kompozitné indexy}
\label{sec:indexy}

V tejto sekcii definujeme 5 kompozitných indexov. Keďže základné centrality sú v komplexných 
sieťach často silne korelované, zavádzame kompozitné indexy, ktoré ich štatisticky odfiltrujú a odhalia špecifické strategické roly 
jednotlivých letísk.
...
Rebríček \textit{Katz centrality} vykazuje vysokú mieru podobnosti s \textit{Degree centrality},  avšak mierne zvýhodňuje uzly s väčším počtom 
nepriamych spojení, pričom vzdialenejšie cesty sú diskontované faktorom útlmu. Najvyššiu hodnotu dosahuje Frankfurt, čo potvrdzuje jeho stabilný 
systémový význam aj v modeli zohľadňujúcom nepriame sieťové vplyvy.
...
V prvej desiatke dominuje európsky región (6 z 10 letísk). V prvej stovke potom Európa tvorí až 48\% všetkých letísk, zatiaľ čo 
Severná Amerika predstavuje približne štvrtinu. Významné je zastúpenie letiska v Dubaji, ktoré vďaka svojej strategickej polohe 
medzi Európou a Áziou maximalizuje tranzitný potenciál napriek menšiemu vnútroštátnemu trhu v porovnaní s americkými letiskami.
...
Z kontinentálneho hľadiska dominujú v rebríčku letiská zo Severnej Ameriky, ktoré predstavujú 52 zo 100 najvýznamnejších uzlov podľa 
\textit{Bridge Indexu}. Výraznejšie zastúpenie majú aj regióny Austrálie a Oceánie (16 letísk), Južnej Ameriky (12) a Afriky (10), 
zatiaľ čo Európa (5) a Ázia (3) sú zastúpené podstatne menej. Tento výsledok naznačuje, že vysoké hodnoty \textit{Bridge Indexu} sú 
typické najmä pre geograficky izolované regióny s obmedzenou dopravnou redundanciou.
