...
\caption{\centering Porovnanie Top 10 globálnych letísk podľa štyroch primárnych centralít.}
\label{tab:top10_raw}
\end{table}
...
\begin{figure}[h!]
    ...
    \caption{\centering Vzťah medzi Degree centrality a Betweenness centrality pre uzly globálnej leteckej siete. Výrazné odchýlky od hlavného 
