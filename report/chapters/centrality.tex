...
\end{tabular}
\caption{Top 10 letísk podľa Global Hub Score (všestranná sieťová dominancia).}
...
8. & Moosonee Airport & Ontário, Kanada \\ \hline
\end{tabular}
\caption{Top letiská podľa Bridge Indexu (Kritické sieťové mosty).}
...
\end{tabular}
\caption{Top 10 letísk podľa Regional Indexu.}
...
mieru konektivity naviazanú na cestovný ruch. Hoci sú tieto letiská kľúčové pre ekonomickú stabilitu a mobilitu v rámci Európy, ich strategický 
význam pre globálnu tranzitnú integritu je v porovnaní s uzlami typu „Bridge“ (napr. Anchorage) výrazne nižší.
...
\end{tabular}
\caption{Top 10 letísk podľa Local Giant Indexu.}
...
ekonomickú stabilitu svojich krajín, no v globálnej topológii fungujú skôr ako masívne izolované distribútory než ako primárne body svetovej prestíže.
...
\end{tabular}
\caption{Top 10 letísk podľa Prestige Indexu.}
