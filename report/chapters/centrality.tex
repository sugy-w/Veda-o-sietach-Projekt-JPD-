...
1.  & Frankfurt (FRA) & Paris (CDG)       & Amsterdam (AMS) & Frankfurt (FRA) & Frankfurt (FRA) \\
2.  & Paris (CDG)     & Los Angeles (LAX) & Frankfurt (FRA) & Paris (CDG)     & Amsterdam (AMS) \\
3.  & Amsterdam (AMS) & Dubai (DXB)       & Paris (CDG)     & London (LHR)    & Paris (CDG)     \\
4.  & Istanbul (IST)  & Anchorage (ANC)   & Munich (MUC)    & Dubai (DXB)     & Istanbul (IST)  \\
5.  & Atlanta (ATL)   & Frankfurt (FRA)   & London (LHR)    & Amsterdam (AMS) & Munich (MUC)    \\
6.  & Chicago (ORD)   & Beijing (PEK)     & Rome (FCO)      & Los Angeles (LAX)& Atlanta (ATL)   \\
7.  & Beijing (PEK)   & Chicago (ORD)     & Barcelona (BCN) & New York (JFK)  & Beijing (PEK)   \\
8.  & Munich (MUC)    & Toronto (YYZ)     & Istanbul (IST)  & Toronto (YYZ)   & Chicago (ORD)   \\
9.  & Moscow (DME)    & Amsterdam (AMS)   & Zürich (ZRH)    & Istanbul (IST)  & London (LHR)    \\
10. & Dallas (DFW)    & Istanbul (IST)    & Madrid (MAD)    & Munich (MUC)    & Dubai (DXB)     \\ \hline
\end{tabular}
}
...
Najvýraznejšie postavenie v sieti dosahujú európske uzly, predovšetkým \textbf{Frankfurt (FRA)}, \textbf{Paris Charles de Gaulle (CDG)} 
a \textbf{Amsterdam Schiphol (AMS)}. Tieto letiská sa opakovane objavujú medzi najvyššie hodnotenými uzlami naprieč všetkými centralitami, 
...
Významnú anomáliu predstavuje letisko \textbf{Anchorage (ANC)}, ktoré sa umiestnilo na štvrtom mieste v rámci \textit{Betweenness centrality}, 
napriek tomu, že sa nevyskytuje v ostatných rebríčkoch Top 10. Tento výsledok naznačuje, že význam ANC nevyplýva z veľkého množstva spojení, 
...
Odlišný charakter vykazujú aj letiská ako \textbf{Atlanta (ATL)} alebo \textbf{Dallas/Fort Worth (DFW)}, ktoré dosahujú vysoké hodnoty 
...
s významnými susedmi. Najvyššiu hodnotu dosahuje \textbf{Frankfurt (FRA)}, čo potvrdzuje jeho stabilný systémový význam 
...
Výrazným outlierom je letisko \textbf{Ted Stevens Anchorage International Airport (ANC)}, ktoré sa nachádza izolovane v ľavej hornej časti grafu. 
...
Naopak, letiská ako \textbf{Charles de Gaulle (CDG)}, \textbf{Frankfurt (FRA)} a \textbf{Amsterdam Schiphol (AMS)} sa nachádzajú v pravom hornom 
...
Zaujímavú skupinu tvoria aj letiská ako \textbf{Beijing Capital International Airport (PEK)} a \textbf{Chicago O'Hare International Airport (ORD)}, 
